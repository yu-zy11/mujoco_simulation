...
class state_estimator_lcmt(object):
    __slots__ = ["p", "vWorld", "vBody", "vRemoter", "rpy", "omegaBody", "omegaWorld", "quat", "aBody", "aWorld", "contactEstimate", "timestamp"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "int64_t"]

    __dimensions__ = [[3], [3], [3], [3], [3], [3], [3], [4], [3], [3], [4], None]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xeb390c8b8230c53f) & 0xffffffffffffffff
